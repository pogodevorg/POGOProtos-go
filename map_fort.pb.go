...
type FortData struct {
	...
	ActiveFortModifier []ItemId      `protobuf:"varint,12,rep,name=active_fort_modifier,json=activeFortModifier,enum=POGOProtos.Inventory.Item.ItemId" json:"active_fort_modifier,omitempty"`
